...
--> statement-breakpoint
ALTER TABLE "wish_list_product" ADD CONSTRAINT "wish_list_product_wish_list_id_address_id_fk" FOREIGN KEY ("wish_list_id") REFERENCES "public"."address"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
